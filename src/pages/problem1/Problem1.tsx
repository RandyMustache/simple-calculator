            ...
            <FormControl sx={{ m: 1, minWidth: 120 }}>
                    ...
                    <Grid container  spacing={1} columns={8}>
                        ...
                        <Grid item  xs={4} justifyContent="center">
                            ...
                            <TextField id="sell-amount" label="Buy" variant="outlined" value={values.amount} required onChange={handleChange('amount')} />
                        </Grid>
                ...
                <Grid item xs={12} >
                    ...
                    <Calculator buy={values.buy} sell={values.sell} amount={values.amount} fixed={"sell"} />
                </Grid>
            </Grid>
        </>
    )
